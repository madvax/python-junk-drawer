...
SUMARY: Sets up a DD-WRT 3.0 Access Point to use WPA2 Personal Security 
...
# -----------------------------------------------------------------------------
# Select WPA2 Personal as the Security Mode  
if VERBOSE:
...
try:
   ...
   securityModeDropdown.select_by_visible_text("WPA2 Personal")
   time.sleep(delay)
except Exception as e:
